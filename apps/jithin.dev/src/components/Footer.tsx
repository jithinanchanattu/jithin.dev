...
function LastUpdate() {
  return (
    <a
      href="https://github.com/jithinanchanattu/jithin.dev"
      target="_blank"
  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Jithin, a <strong>front-end developer</strong> who loves
        intuitive, clean and modern UI design.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://twitter.com/getjithin"
            target="_blank"
            rel="noreferrer nofollow"
        ...
        <li>
          <a
            href="https://github.com/jithinanchanattu"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
        ...
        <li>
          <a
            href="https://www.figma.com/@jithinjoji"
            target="_blank"
            rel="noreferrer nofollow"
            className={clsx('flex h-9 w-9 items-center justify-center')}
      ...
      <div className={clsx('content-wrapper')}>
        ...
        >
          <div className={clsx('font-semibold')}>
            &copy; {dayjs().format('YYYY')}, Jithin Joji Anchanattu
          </div>
